...
class Validate:
    # Дескриптор на проверку в ФИО наличия первой заглавной буквы,
...
if __name__ == '__main__':
    student_1 = Student("Виталий", "Владимирович", "Лушников", Path('lessons.csv'))
    ...
    student_2 = Student("Ольга", "Олеговна", "Москвина", Path('lessons.csv'))
